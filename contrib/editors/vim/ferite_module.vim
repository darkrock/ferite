...
" Note: modified c.vim sytanx file maintained by Bram Moolenaar <Bram@vim.org>  Mfor ferite
...
" The ferite script stuff
syn keyword feStatement		new self uses return super break continue include delete rename isa instanceof closure using 
syn keyword feConditional	if else
syn keyword feRepeat		for do while
...
syn keyword feStructure		protocol implements class function namespace extends modifies arguments deliver recipient module-init module-register module-unregister module-deinit module-header
